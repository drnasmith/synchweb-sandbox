<template>
    ...
    <div v-show="isLoggedIn" class="tw-flex tw-flex-col tw-bg-sidebar-grad-end md:tw-bg-gray-200 md:tw-flex-row tw-justify-center tw-my-2 md:tw-mx-4">
        ...
        <a href="#" class="tw-relative md:tw-w-48 tw-py-4 tw-bg-sidebar-grad-end tw-border tw-border-gray-400 tw-text-gray-800 tw-text-center tw-text-xs"
            ...
            <div v-show="showProposalMenu && proposal">
                <div class="tw-absolute tw-left-0 tw-mt-4 tw-w-full">
                    <ul class="tw-border-t tw-border-l tw-border-r">
                        <li class="tw-w-full tw-border-b tw-border-gray-400 hover:tw-text-white tw-bg-sidebar-grad-end  hover:tw-bg-blue-400">
